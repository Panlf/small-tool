...
public class SM4Utils {
    ...
    public static String decryptBase64_CBC(String data, String key, String iv, Padding padding) {
        return new String(decrypt_CBC(
                BASE64_DECODER.decode(data.getBytes(StandardCharsets.UTF_8)),
                BASE64_DECODER.decode(key.getBytes(StandardCharsets.UTF_8)),
                BASE64_DECODER.decode(iv.getBytes(StandardCharsets.UTF_8)),
                padding
        ), StandardCharsets.UTF_8);
    }
